...
//        return exists[existenceKey];
        self.getCollection(function(err, collection) {
          if (err) {
            return callback(err);
          }
          console.log("Inside /Users/terranceford/vagrant/src/socket-service/question/context/context.js.retrieve, about to collection.find with criteria:\n", self.getCriteria());
          collection.find(self.getCriteria()).toArray(function(err, results) {
            console.log("Inside /Users/terranceford/vagrant/src/socket-service/question/context/context.js.retrieve, got called with err, results of:\n", err, "\n", results);
            if (err) {
              return callback(err);
            }
...
console.log("Inside /Users/terranceford/vagrant/src/socket-service/question/context/context.js.evolveOperation, got called with operation:\n", operation);
      var self = this;

var i = 0; // TODO remove me (figure out why you needed me)
console.log("INside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js.evolveOperation, about to evolve operation:\n", operation);
console.log("Inside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js.evolveOperation, about to use operationFactory:\n", operationFactory);
//      operation = operationFactory.create(operation);
...
//      });
      self.checkHowManyOps(function(err, howManyOps) {
        ...
        async.whilst(
          function() { 
            i++
            console.log("about to check against howManyOps:\n", howManyOps);
            return (operation.context < howManyOps && i < 10); 
          },
          function(cb) {
...
console.log("Inside /Users/terranceford/vagrant/src/socket-service/question/context/context.js.evolveOperation, about to evolve operation:\n", operation);
console.log("Inside /Users/terranceford/vagrant/src/socket-service/question/context/context.js.evolveOperation, about to evolveBy completedOperation:\n", completedOperation);

              operation = operation.evolveBy(completedOperation);
console.log("The evolved operation is:\n", operation);
              cb();
            });
          },
          function(err) {
console.log("Inside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js.evolveOperation, the whilst final function, got called.\n");
            if (err) {
              return callback(err);
            }
console.log("INside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js.evolveOperation, the whilst final function, about to callback with null, operation of:\n", operation);
...
console.log("Inside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js._getOperation, got called\n");
      var self = this;
      var persistantOperation = self.getPersistantOperation();
console.log("Inside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js._getOperation, the persistantOperation is:\n", persistantOperation);
      var criteria = null;

      criteria = _.extend(persistantOperation.getCriteria(), {
        context : context
      });
console.log("INside /Users/terranceford/vagrant/src/socket-service/lib/context/context.js._getOperation, the criteria is:\n", criteria);
...
//          callback(null, operationFactory.create(rawOperation));
