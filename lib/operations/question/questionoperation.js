...
var QuestionOperation = classify({
  ...
  instanceMethods : {
    ...
    evolveByInsert : function() {
      throw new Error("evolveByInsert unimplimented");
    },
    evolveByDelete : function() {
      throw new Error("evolveByDelete unimplimented");
    },
    evolveByIncrementState : function() {
      throw new Error("evolveByIncrementState unimplimented");
    },
    onQueued : function() {
